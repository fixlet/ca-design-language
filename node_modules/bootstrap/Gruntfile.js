...
module.exports = function (grunt) {
  ...
  grunt.registerTask('sass-compile', ['exec:sass'])
  grunt.registerTask('sass-compile-with-docs', ['exec:sass', 'exec:sass-docs'])

  grunt.registerTask('dist-css', ['sass-compile', 'exec:postcss', 'exec:clean-css'])
  grunt.registerTask('dist-css-with-docs', ['sass-compile', 'exec:postcss', 'exec:clean-css', 'exec:clean-css-docs'])
